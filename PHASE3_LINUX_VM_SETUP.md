...
| M3 | RajaBee | tier-RB | `glm-4.7-flash` (30B/3B active, thinking mode), `gemma4:26b-moe` (26B/3.8B active, 88.3% AIME math), `mixtral:8x7b` (47B/13B active, borderline at q3), `nemotron-cascade-2:30b` (30B/3B active, NVIDIA, competitive programming + STEM), `qwen3:30b-a3b-thinking` (30B/3B active, 262K context, reasoning variant), `qwen3-coder-next:32b` (32B coder variant), `nemotron-3-nano:30b` (also confirmed as hybrid MoE in "big MoE" search — already in D4 dense, dual-classified). Out-of-budget: deepseek-v3.2 671B, qwen3.5 397B-A17B, glm-5 744B, kimi-k2.5 1T, qwen3 235B-A22B, mixtral 8x22B, mistral-3-large 675B (256K context, from "big MoE"). | _pending_ |
